...
public:
    ...
    virtual void sync_write(IODevice* iodev, const char* data, uint32_t size, uint64_t offset) override;
    virtual void sync_writev(IODevice* iodev, const iovec* iov, int iovcnt, uint32_t size, uint64_t offset) override;
    virtual void sync_read(IODevice* iodev, char* data, uint32_t size, uint64_t offset) override;
    virtual void sync_readv(IODevice* iodev, const iovec* iov, int iovcnt, uint32_t size, uint64_t offset) override;
    virtual void sync_write_zero(IODevice* iodev, uint64_t size, uint64_t offset) override;
...
private:
    void write_zero_ioctl(const IODevice* iodev, uint64_t size, uint64_t offset);
    void write_zero_writev(IODevice* iodev, uint64_t size, uint64_t offset);
